...
function edit($id) {
  $.get("editinter.php?id="+$id,function(data)
    {
        $(".changedtr"+$id).html(data);
    });
}
function cancel() {
  location.href="man_inter.php";
}
function cha($page,$order,$sort) {
  $.get("m_se.php?page="+$page+"&&order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
function chaa($order,$sort) {
  $.get("m_se.php?order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
