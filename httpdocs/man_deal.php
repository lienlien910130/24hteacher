...
function edit($id) {
  $.get("editpay.php?id="+$id,function(data)
    {
        $(".changedtr"+$id).html(data);
    });
}
function cancel() {
  location.href="man_deal.php";
}
function cha($page,$order,$sort) {
  $.get("m_ei.php?page="+$page+"&&order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
function chaa($order,$sort) {
  $.get("m_ei.php?order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
