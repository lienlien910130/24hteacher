...
function cha($page,$order,$sort) {
  $.get("my_tw.php?page="+$page+"&&order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
function chaa($order,$sort) {
  $.get("my_tw.php?order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
