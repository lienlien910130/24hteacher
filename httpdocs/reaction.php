      ...
      <div class="container">
        <div class="wid">
          ...
          <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
           <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 reaction">
              <h3 class="title">意見反應管理</h3>
           </div>  
            <div id="person" class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="margin-top: 10px;">
            <?php include_once 'm_fo.php';?>
           </div>
          </div>
        </div>
      </div>
...
function cha($page,$order,$sort) {
  $.get("m_fo.php?page="+$page+"&&order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
function chaa($order,$sort) {
  $.get("m_fo.php?order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
