...
function cha($page,$order,$sort) {
  $.get("m_ten.php?page="+$page+"&&order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
function chaa($order,$sort) {
  $.get("m_ten.php?order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
function edit($id) {
  $.get("editman_note.php?id="+$id,function(data)
    {
        $(".changedtr"+$id).html(data);
    });
}
function cancel() {
  location.href="man_notes.php";
}
