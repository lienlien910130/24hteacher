...
$pdo =DB_CONNECT();
$text_case_s = @$_GET["text_case_s"];
//$text_case_sid = @$_GET["text_case_sid"];
$text_case_a = @$_GET["text_case_a"];
   ...
   <div class="overlay"></div>
    ...
    <div id="content">
      ...
      <div class="wid">
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 a1">
          <h2 class="se_hr">您的案件條件</h2>
          ...
          <div class="col-lg-4 hidden-xs hidden-sm hidden-md">
            ...
            if($text_case_s !=""){
              ?>
              <a class="form-control form-select ajax-processed o" data-toggle="modal" href="#myObj"><?php echo $text_case_s?></a>
              <?php
          ...
          <div class="col-lg-4 hidden-xs hidden-sm hidden-md">
            ...
            if($text_case_a !=""){
              ?>
              <a class="form-control form-select ajax-processed o" data-toggle="modal" href="#myArea"><?php echo $text_case_a?></a>
              <?php 
          ...
          <div class="col-lg-4 hidden-xs hidden-sm hidden-md">
            <div id="m_time">
              <a class="form-control form-select ajax-processed o" data-toggle="modal" href="#myTime">上課時間</a>
              <input type="text" name="time" id="time" value="-1" style="display: none;">
             </div>
          </div> 
          </div>
          ...
          <!-- <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6"> -->
            <button id="button3id" name="button3id" class="btn bu qq" type="button" onclick="cancela()" style="bottom: 0px;border-radius: 10px;color: white;padding: 15px;">重新設定</button> 
           <!--  </div> -->
            <!-- <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6"> -->
            <button id="button3id" name="button3id" class="btn bu ww" type="button" onclick="search_case()" style="bottom: 0px;border-radius: 10px;color: white;padding: 15px;">送出條件</button>
            <!-- </div> -->
          </div>
          </div>
        </div>
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
          ...
          <div id="sec_change">
          <?php 
           // if($text_case_a != "" || $text_case_s != ""){
           //   include_once 'ca_table_text.php';
           // }else{
             include_once 'ca_table.php';
           //}
          ?>
          </div>
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            ...
            <img src="<?php echo $pic[11]?>" class="img-responsive" style="">
            </div>
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
           <?php
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 img-responsive">
             <h2 class="se_hr">最新案件</h2>
                <img src="<?php echo $pic[12]?>" class="img-responsive" style="">
              </div>
              <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                 <?php
...
function cha($page,$order,$sort,$obj,$sub,$area,$exper,$sala,$timess,$textnu) {
  $.ajax({
      type:'POST',
      url :'ca_table.php',
      data:"obj="+$obj+"&sub="+$sub+"&area="+$area+"&exper="+$exper+"&sala="+$sala+"&timess="+$timess+"&page="+$page+"&order="+$order+"&sort="+$sort+"&textnu="+$textnu,
      dataType:'html', 
...
function chaa($order,$sort,$obj,$sub,$area,$exper,$sala,$timess,$textnu) {
  
   $.ajax({
      type:'POST',
      url :'ca_table.php',
      data:"obj="+$obj+"&sub="+$sub+"&area="+$area+"&exper="+$exper+"&sala="+$sala+"&timess="+$timess+"&order="+$order+"&sort="+$sort+"&textnu="+$textnu,
      dataType:'html', 
      success : function(data){
        $("#sec_change").html(data);
      }
...
function search_case(){
    ...
    //alert(obj+"/"+sub+"/"+area+"/"+exper+"/"+sala+"/"+timess);
    if(obj == -1 && sub == -1 && area == -1 && exper == -1 && sala == -1 
     ...
     // alert(obj+"/"+sub+"/"+area+"/"+exper+"/"+sala+"/"+timess);
      ...
      type:'POST',
      url :'ca_table.php',
      data:"obj="+obj+"&sub="+sub+"&area="+area+"&exper="+exper+"&sala="+sala+"&timess="+timess,
      dataType:'html', 
      success : function(data){
        $("#sec_change").html(data);
      }
