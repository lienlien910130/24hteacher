...
function cha($page,$order,$sort) {
  $.get("m_o.php?page="+$page+"&&order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
function chaa($order,$sort) {
  $.get("m_o.php?order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
