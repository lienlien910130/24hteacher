    ...
    <div id="content">
      <div class="container">
        <div class="wid">
          ...
          <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12 case_mang">
...
function cha($page,$order,$sort) {
  $.get("m_t.php?page="+$page+"&&order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
function chaa($order,$sort) {
  $.get("m_t.php?order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
