    ...
    <div id="content">
      <div class="container">
        <div class="wid">
          ...
          <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12 clo man_new">
          <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
              <h3 class="title">訂閱者管理</h3>
          </div>
          <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ">
              <?php 
              $pdo =DB_CONNECT();
...
function edit($id) {
  $.get("editmannews.php?id="+$id,function(data)
    {
...
function cha($page,$order,$sort) {
  $.get("m_fi.php?page="+$page+"&&order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
function chaa($order,$sort) {
  $.get("m_fi.php?order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
...
function deletess($id){
  ...
  var r = confirm("刪除後無法再恢復該項記錄，確定刪除該筆資料?");
  if (r == true) {
      $.ajax({
            type:'POST',
