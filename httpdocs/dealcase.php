...
<form class="form-horizontal" style="margin:30px 0px 20px 0px" name="casedealForm" id="casedealForm" action="casedealProc.php" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
              <fieldset>
              <?php 
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-md-4 control-label" for="textinput">面談薪資</label>
                <div class="col-md-4">
