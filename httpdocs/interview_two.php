...
function cha($page,$order,$sort,$id) {
  $.get("my_se.php?page="+$page+"&&order="+$order+"&&sort="+$sort+"&&id="+$id,function(data)
  {
      $("#person").html(data);
  });
}
function chaa($order,$sort,$id) {
  $.get("my_se.php?order="+$order+"&&sort="+$sort+"&&id="+$id,function(data)
  {
      $("#person").html(data);
  });
}
...
function changedeal($id,$status){
  var id = $id;
  $.get("dealcase.php?id="+id,function(data)
  {
    $("#person").html(data);
  });
}
