...
function cha($page,$order,$sort) {
  $.get("my_twel.php?page="+$page+"&&order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
function chaa($order,$sort) {
  $.get("my_twel.php?order="+$order+"&&sort="+$sort,function(data)
  {
      $("#person").html(data);
  });
}
